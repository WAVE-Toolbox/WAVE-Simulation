...
namespace KITGPI
{
    ...
    namespace Wavefields
    {
        ...
        class FD2Delastic : public WavefieldsSeismic<ValueType>
        {
          ...
          public:
            ...
            explicit FD2Delastic(scai::hmemo::ContextPtr ctx, scai::dmemo::DistributionPtr dist, scai::IndexType numRelaxationMechanisms_in);
