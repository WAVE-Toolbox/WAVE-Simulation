 ...
 */
template <typename ValueType>
void KITGPI::Wavefields::FD2Dvisco<ValueType>::write(IndexType snapType, std::string baseName,std::string type, IndexType t, KITGPI::ForwardSolver::Derivatives::Derivatives<ValueType> const &derivatives, scai::lama::Vector const &SWaveModulus, scai::lama::Vector const &PWaveModulus, IndexType partitionedOut)
{
 ...
 */
template <typename ValueType>
void KITGPI::Wavefields::FD2Dvisco<ValueType>::writeSnapshot(IndexType snapType, std::string baseName,IndexType t, KITGPI::ForwardSolver::Derivatives::Derivatives<ValueType> const &derivatives, scai::lama::Vector const &SWaveModulus, scai::lama::Vector const &PWaveModulus, IndexType partitionedOut)
{
...
template <typename ValueType>
void KITGPI::Wavefields::FD2Dvisco<ValueType>::getCurl(KITGPI::ForwardSolver::Derivatives::Derivatives<ValueType> const &derivatives, scai::lama::Vector &curl, scai::lama::Vector const &SWaveModulus)
{
...
template <typename ValueType>
void KITGPI::Wavefields::FD2Dvisco<ValueType>::getDiv(KITGPI::ForwardSolver::Derivatives::Derivatives<ValueType> const &derivatives, scai::lama::Vector &div, lama::Vector const &PWaveModulus)
{
    scai::lama::Matrix const &Dxb = derivatives.getDxb();
    scai::lama::Matrix const &Dyb = derivatives.getDzb();
