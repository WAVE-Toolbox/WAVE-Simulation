...
KITGPI::Acquisition::SourceSignal::SinW<ValueType>::SinW(scai::lama::DenseVector<ValueType> &signal, IndexType NT, ValueType DT, ValueType FC, ValueType AMP, ValueType Tshift)
{
 ...
 */
template <typename ValueType>
void KITGPI::Acquisition::SourceSignal::SinW<ValueType>::calc(scai::lama::DenseVector<ValueType> &signal, IndexType NT, ValueType DT, ValueType FC, ValueType AMP, ValueType Tshift)
{
