    ...
    namespace Modelparameter
    {
        ...
        class EMEM : public ModelparameterEM<ValueType>
        {
          public:
            ...
            explicit EMEM(scai::hmemo::ContextPtr ctx, scai::dmemo::DistributionPtr dist, ValueType magneticPermeabilityEM_const, ValueType conductivityEM_const, ValueType dielectricPermittivityEM_const);
