    ...
    namespace ForwardSolver
    {
        ...
        class FD2Dvisco : public ForwardSolver<ValueType>
        {
          ...
          public:
            ...
            void initForwardSolver(Configuration::Configuration const &config, Derivatives::Derivatives<ValueType> &derivatives, Wavefields::Wavefields<ValueType> &wavefield, const Modelparameter::Modelparameter<ValueType> &model,Acquisition::Coordinates const &modelCoordinates, scai::hmemo::ContextPtr ctx, ValueType DT) override;
