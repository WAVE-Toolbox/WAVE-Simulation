    ...
    namespace ForwardSolver
    {
        ...
        namespace SourceReceiverImpl
        {
            ...
            class SourceReceiverImplSeismic : public SourceReceiverImpl<ValueType>
            {
              public:
                //! Default constructor
                SourceReceiverImplSeismic() = delete;
                explicit SourceReceiverImplSeismic(Acquisition::AcquisitionGeometry<ValueType> const &sourceConfig, Acquisition::AcquisitionGeometry<ValueType> &receiverConfig, Wavefields::Wavefields<ValueType> &wavefieldIN);
                //! Default destructor
