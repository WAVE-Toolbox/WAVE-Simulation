        ...
        namespace SourceReceiverImpl
        {
            ...
            class FDTD2Delastic : public SourceReceiverImpl<ValueType>
            {
              public:
                ...
                void applySourceVZ(Acquisition::Seismogram<ValueType> const &/*seismo*/, Wavefields::Wavefields<ValueType> &/*wavefield*/, IndexType /*t*/) override{COMMON_THROWEXCEPTION("VY sources can not be implemented in 2D elastic modeling")};
                void gatherSeismogramVZ(Acquisition::Seismogram<ValueType> &/*seismo*/, Wavefields::Wavefields<ValueType> &/*wavefield*/, IndexType /*t*/) override{COMMON_THROWEXCEPTION("VY receivers can not be implementedin 2D elastic modeling")};
