...
namespace KITGPI
{
    ...
    namespace Acquisition
    {
        ...
        class AcquisitionGeometryEM
        {
          ...
          public:
            AcquisitionGeometryEM() : numTracesGlobal(0), numTracesLocal(0), numParameter(0){};
            ~AcquisitionGeometryEM(){};
          ...
          private:
            ...
            scai::lama::DenseVector<scai::IndexType> seismogramTypes; //!< #SeismogramTypeEM of the traces: 1==Pressure, 2==hX, 3==hY, 4==hZ
        ...
        *
        * seismogram coordinates and Seismogram Types are stored in vectors and redistributed according to the distribution of the wavefield.
