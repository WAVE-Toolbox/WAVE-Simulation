...
typename KITGPI::ForwardSolver::ForwardSolverEM<ValueType>::ForwardSolverPtr KITGPI::ForwardSolver::FactoryEM<ValueType>::Create(std::string dimension, std::string type)
{
...
template class KITGPI::ForwardSolver::FactoryEM<double>;
template class KITGPI::ForwardSolver::FactoryEM<float>;
