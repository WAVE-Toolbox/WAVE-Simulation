    ...
    namespace ForwardSolver
    {
        ...
        namespace SourceReceiverImpl
        {
            ...
            public:
                ...
                */
                static SourceReceiverImplPtr Create(std::string dimension, std::string type, Acquisition::AcquisitionGeometryEM<ValueType> const &sourceConfig, Acquisition::AcquisitionGeometryEM<ValueType> &receiverConfig, Wavefields::WavefieldsEM<ValueType> &wavefieldIN);
            };
