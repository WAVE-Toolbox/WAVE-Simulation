...
KITGPI::ForwardSolver::BoundaryCondition::FreeSurfaceEMEM<ValueType>::~FreeSurfaceEMEM(){};
 ...
 */
template <typename ValueType>
void KITGPI::ForwardSolver::BoundaryCondition::FreeSurfaceEMEM<ValueType>::init(scai::dmemo::DistributionPtr dist, KITGPI::ForwardSolver::Derivatives::Derivatives<ValueType> &derivatives, Acquisition::Coordinates<ValueType> const &modelCoordinates, ValueType /*DT*/)
{
...
template class KITGPI::ForwardSolver::BoundaryCondition::FreeSurfaceEMEM<float>;
template class KITGPI::ForwardSolver::BoundaryCondition::FreeSurfaceEMEM<double>;
