...
void KITGPI::ForwardSolver::BoundaryCondition::ABSEM2D<ValueType>::apply(scai::lama::Vector<ValueType> &v1, scai::lama::Vector<ValueType> &v2, scai::lama::Vector<ValueType> &v3)
{
 ...
 */
template <typename ValueType>
ValueType KITGPI::ForwardSolver::BoundaryCondition::ABSEM2D<ValueType>::estimateMemory(IndexType BoundaryWidth, IndexType useFreeSurface, scai::dmemo::DistributionPtr dist, Acquisition::Coordinates<ValueType> const &modelCoordinates)
{
 ...
 */
template <typename ValueType>
void KITGPI::ForwardSolver::BoundaryCondition::ABSEM2D<ValueType>::init(scai::dmemo::DistributionPtr dist, scai::hmemo::ContextPtr ctx, Acquisition::Coordinates<ValueType> const &modelCoordinates, IndexType BoundaryWidth, ValueType DampingCoeff, scai::IndexType useFreeSurface)
{
...
template class KITGPI::ForwardSolver::BoundaryCondition::ABSEM2D<double>;
template class KITGPI::ForwardSolver::BoundaryCondition::ABSEM2D<float>;
