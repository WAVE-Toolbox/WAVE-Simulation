...
void KITGPI::ForwardSolver::BoundaryCondition::ABSEM3D<ValueType>::apply(
 ...
 */
template <typename ValueType>
ValueType KITGPI::ForwardSolver::BoundaryCondition::ABSEM3D<ValueType>::estimateMemory(IndexType BoundaryWidth, IndexType useFreeSurface, scai::dmemo::DistributionPtr dist, Acquisition::Coordinates<ValueType> const &modelCoordinates)
{
 ...
 */
template <typename ValueType>
void KITGPI::ForwardSolver::BoundaryCondition::ABSEM3D<ValueType>::init(dmemo::DistributionPtr dist, hmemo::ContextPtr ctx, Acquisition::Coordinates<ValueType> const &modelCoordinates, IndexType BoundaryWidth, ValueType DampingCoeff, scai::IndexType useFreeSurface)
{
...
template class KITGPI::ForwardSolver::BoundaryCondition::ABSEM3D<float>;
template class KITGPI::ForwardSolver::BoundaryCondition::ABSEM3D<double>;
