...
namespace KITGPI {
    ...
    namespace Configuration {
        ...
        public:
            ...
            IndexType getPartitionedIn() const { return PartitionedIn; } ///< Return parallelize input
            IndexType getPartitionedOut() const { return PartitionedOut; } ///< Return parallelize input
 ...
 */
template<typename ValueType>
KITGPI::Configuration::Configuration<ValueType>::Configuration( std::string const& filename ):NumParameters(30),numRelaxationMechanisms(0)
{
