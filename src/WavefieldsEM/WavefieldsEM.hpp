...
namespace KITGPI
{
    ...
    namespace Wavefields
    {
         ...
         *
         * WavefieldsEM implements some methods, which are required by all derived classes.
        ...
        class WavefieldsEM : public Wavefields<ValueType>
        {
          ...
          public:
            ...
            virtual void applyTransform(scai::lama::Matrix<ValueType> const &lhs, KITGPI::Wavefields::Wavefields<ValueType> &rhs) = 0;
