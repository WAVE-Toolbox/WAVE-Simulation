 ...
 */
template <typename ValueType>
KITGPI::Wavefields::FD2Demem<ValueType>::FD2Demem(scai::hmemo::ContextPtr ctx, scai::dmemo::DistributionPtr dist)
{
    equationType = "emem";
    numDimension = 2;
    init(ctx, dist);
...
template <typename ValueType>
void KITGPI::Wavefields::FD2Demem<ValueType>::init(scai::hmemo::ContextPtr ctx, scai::dmemo::DistributionPtr dist)
{
...
template <typename ValueType>
ValueType KITGPI::Wavefields::FD2Demem<ValueType>::estimateMemory(dmemo::DistributionPtr dist)
{
 ...
 */
template <typename ValueType>
void KITGPI::Wavefields::FD2Demem<ValueType>::write(IndexType snapType, std::string baseName, IndexType t, KITGPI::ForwardSolver::Derivatives::Derivatives<ValueType> const & /*derivatives*/, Modelparameter::ModelparameterEM<ValueType> const & /*model*/, IndexType fileFormat)
{
...
//! \brief Not valid in the 2Dememcase
template <typename ValueType>
scai::lama::DenseVector<ValueType> &KITGPI::Wavefields::FD2Demem<ValueType>::getRefRX()
{
...
//! \brief Not valid in the 2Dememcase
template <typename ValueType>
scai::lama::DenseVector<ValueType> &KITGPI::Wavefields::FD2Demem<ValueType>::getRefRY()
{
...
//! \brief Not valid in the 2Dememcase
template <typename ValueType>
scai::lama::DenseVector<ValueType> &KITGPI::Wavefields::FD2Demem<ValueType>::getRefRZ()
{
 ...
 */
template <typename ValueType>
void KITGPI::Wavefields::FD2Demem<ValueType>::assign(KITGPI::Wavefields::WavefieldsEM<ValueType> &rhs)
{
    HZ = rhs.getRefHZ();
    EX = rhs.getRefEX();
    EY = rhs.getRefEY();
 ...
 */
template <typename ValueType>
void KITGPI::Wavefields::FD2Demem<ValueType>::minusAssign(KITGPI::Wavefields::WavefieldsEM<ValueType> &rhs)
{
    HZ -= rhs.getRefHZ();
    EX -= rhs.getRefEX();
    EY -= rhs.getRefEY();
 ...
 */
template <typename ValueType>
void KITGPI::Wavefields::FD2Demem<ValueType>::plusAssign(KITGPI::Wavefields::WavefieldsEM<ValueType> &rhs)
{
    HZ += rhs.getRefHZ();
    EX += rhs.getRefEX();
    EY += rhs.getRefEY();
