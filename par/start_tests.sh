...
Simulation_EXE="${BINDIR}/Simulation"
...
mpirun -np ${NUM_MPI_PROCESSES} ${Simulation_EXE} ci/configuration_ci.2D.sh.txt
...
mpirun -np ${NUM_MPI_PROCESSES} ${Simulation_EXE} ci/configuration_ci.2D.acoustic.txt
...
mpirun -np ${NUM_MPI_PROCESSES} ${Simulation_EXE} ci/configuration_ci.2D.acoustic.varGrid.txt
...
mpirun -np ${NUM_MPI_PROCESSES} ${Simulation_EXE} ci/configuration_ci.3D.acoustic.varGrid.txt
...
mpirun -np ${NUM_MPI_PROCESSES} ${Simulation_EXE} ci/configuration_ci.3D.acoustic.txt
...
mpirun -np ${NUM_MPI_PROCESSES} ${Simulation_EXE} ci/configuration_ci.2D.elastic.txt
...
mpirun -np ${NUM_MPI_PROCESSES} ${Simulation_EXE} ci/configuration_ci.3D.elastic.txt
...
mpirun -np ${NUM_MPI_PROCESSES} ${Simulation_EXE} ci/configuration_ci.2D.visco.txt
...
mpirun -np ${NUM_MPI_PROCESSES} ${Simulation_EXE} ci/configuration_ci.3D.visco.txt
